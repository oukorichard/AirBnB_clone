...
```
git clone https://github.com/oukorichard/AirBnB_clone.git
```
...
Ubuntu 20.04, gnu, and Python3 language.

## Authors



Rochard ouko| Github: [oukorichard](https://github.com/oukorichard)
